...
def main():
    ...
    def send_question(message):
        ...
        temp_user_data.temp_data(message.chat.id)[message.chat.id][0] = 0
    ...
    def text(message):
        ...
        if user_current_action == 0:
            if temp_user_data.temp_data(user_id)[user_id][3] == -1:
                ...
                temp_user_data.temp_data(user_id)[user_id][4].extend(chat_gpt.gpt_query(user_input, temp_user_data.temp_data(user_id)[user_id][1], 0))
